...
| Lyrical     | [master](https://github.com/ros-controls/control_msgs/tree/master) | see above <br> [![build.ros2.org](https://build.ros2.org/buildStatus/icon?job=Ldev__control_msgs__ubuntu_resolute_amd64&subject=build.ros2.org)](https://build.ros2.org/job/Ldev__control_msgs__ubuntu_resolute_amd64/) |  [![Package Build](https://build.ros2.org/buildStatus/icon?job=Lbin_uR64__control_msgs__ubuntu_resolute_amd64__binary)](https://build.ros2.org/job/Lbin_uR64__control_msgs__ubuntu_noble_amd64__binary/) |
